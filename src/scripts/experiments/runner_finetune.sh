#!/bin/bash
#SBATCH --job-name=ft3      # Job name
#SBATCH --output=output_ft3.log           # Standard output log
#SBATCH --error=error_ft3.log             # Standard error log
...
# torchrun --nproc_per_node=2 --master_port=29507 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/microsoft/Phi-3-small-128k-instruct master-large 5 1
# torchrun --nproc_per_node=2 --master_port=29507 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/microsoft/Phi-3-medium-128k-instruct master-large 5 1
...
# torchrun --nproc_per_node=2 --master_port=29506 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/microsoft/phi-4 master-large 5 1
...
# torchrun --nproc_per_node=2 --master_port=29506 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/Qwen/Qwen2.5-14B-Instruct master-large 5 2

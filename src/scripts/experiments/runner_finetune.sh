...
# torchrun --nproc_per_node=2 --master_port=29508 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/microsoft/Phi-3-small-128k-instruct master-large 5 2
# torchrun --nproc_per_node=2 --master_port=29508 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/microsoft/Phi-3-medium-128k-instruct master-large 5 2

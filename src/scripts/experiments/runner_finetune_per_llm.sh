#!/bin/bash
#SBATCH --job-name=per_llm3      # Job name
#SBATCH --output=per_llm3.log           # Standard output log
#SBATCH --error=per_llm3.log             # Standard error log
...
# torchrun --nproc_per_node=2 --master_port=29501 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/meta-llama/Llama-3.2-3B-Instruct detect-Llama-3.2-3B-Instruct 5 8
...
# torchrun --nproc_per_node=2 --master_port=29504 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/microsoft/Phi-3-medium-128k-instruct detect-Phi-3-medium-128k-instruct 5 1
...
# torchrun --nproc_per_node=2 --master_port=29504 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/microsoft/phi-4 detect-phi-4 5 1
...
# torchrun --nproc_per_node=2 --master_port=29503 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/mistralai/Ministral-8B-Instruct-2410 detect-Ministral-8B-Instruct-2410 5 4
...
# torchrun --nproc_per_node=2 --master_port=29501 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/Qwen/Qwen2.5-14B-Instruct detect-Qwen2.5-14B-Instruct 5 2
# torchrun --nproc_per_node=2 --master_port=29501 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/Qwen/Qwen2.5-7B-Instruct detect-Qwen2.5-7B-Instruct 5 4
# torchrun --nproc_per_node=2 --master_port=29501 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/Qwen/Qwen2.5-3B-Instruct detect-Qwen2.5-3B-Instruct 5 8

#!/bin/bash
#SBATCH --job-name=per_llmfam4      # Job name
...
# Qwen
# torchrun --nproc_per_node=2 --master_port=29511 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/Qwen/Qwen2-7B-Instruct detect-qwen-family 5 4
...
# torchrun --nproc_per_node=2 --master_port=29511 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/Qwen/Qwen2.5-7B-Instruct detect-qwen-family 5 4
# torchrun --nproc_per_node=2 --master_port=29511 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/Qwen/Qwen2.5-3B-Instruct detect-qwen-family 5 8

# Falcon
# torchrun --nproc_per_node=2 --master_port=29512 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/tiiuae/Falcon3-7B-Instruct detect-falcon-family 5 4
# torchrun --nproc_per_node=2 --master_port=29512 training_finetune.py /mnt/evafs/groups/re-com/mgromadzki/llms/tiiuae/Falcon3-3B-Instruct detect-falcon-family 5 8

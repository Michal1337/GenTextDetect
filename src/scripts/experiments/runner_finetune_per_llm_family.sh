...
#SBATCH --output=per_llmf6.log           # Standard output log
#SBATCH --error=per_llmf6.log             # Standard error log
...
# Microsoft
torchrun --nproc_per_node=2 --master_port=29513 training_finetune.py /mnt/evafs/gEroups/re-com/mgromadzki/llms/microsoft/Phi-3-mini-128k-instruct detect-phi-family 5 4
